...
MAINFILE="kandy.php" # this should be the name of your main php file in the wordpress plugin

# git config
GITPATH="C:\\xampp\\htdocs\\wordpress\\wp-content\\plugins\\kandy" # this should be the path to your git repository (trailing slash required)

# svn config
SVNPATH="C:\\xampp\\htdocs\\svn\\kandy" # path to your checked out SVN repo. Trailing slash is required and don't add trunk.
SVNUSER="kodeplusdev" # your svn username
